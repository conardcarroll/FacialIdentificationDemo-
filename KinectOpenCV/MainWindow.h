...
private:
    ...
    /// </summary>
    /// <param name="value">frame rate to convert into string</param>
	std::wstring GetFaceID(int faceID);
	...
	std::wstring GenerateStreamInformation(NUI_IMAGE_RESOLUTION resolution, int filterID, double frameRate, int faceID);
	...
	OpenCVFaceRecognition m_openCVFaceRecog ;
